 ...
 */
package br.savio.vuttr.basic.service;

import br.savio.vuttr.basic.model.BasicEntity;
import br.savio.vuttr.basic.interfaces.DAO;
import br.savio.vuttr.utils.ReflectionUtils;
...
public abstract class GenericDAOImpl<T extends BasicEntity> implements DAO<T> {
    ...
    @PostConstruct
    private void init() {
        this.entityManagerFactory = Persistence.createEntityManagerFactory("vuttr");
