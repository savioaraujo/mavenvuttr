 ...
 */
package br.savio.vuttr.webservice;

import br.savio.vuttr.model.Tool;
import br.savio.vuttr.service.TagDAO;
import br.savio.vuttr.service.ToolDAO;
import br.savio.vuttr.utils.ToolUtils;
...
public class ToolRESTService {
    ...
    public String listAll(@QueryParam("tag") String tag) {
        if (!Utils.isEmpty(tag)) {
            return gson.toJson(ToolUtils.parseToVO(toolDAO.findByTags(tag)));
        } else {
